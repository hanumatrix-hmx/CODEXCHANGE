...
export default async function SignupPage({
    ...
    const signUpWithGoogle = async () => {
        ...
        if (error) {
            ...
            return redirect(`/signup?message=Could not authenticate with Google: ${error.message}`);
        }
    ...
    const signUpWithGithub = async () => {
        ...
        if (error) {
            ...
            return redirect(`/signup?message=Could not authenticate with GitHub: ${error.message}`);
        }
