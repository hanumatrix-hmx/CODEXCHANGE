            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between gap-4">
                    ...
                    <nav className="hidden md:flex items-center gap-8 h-full">
                        ...
                        <Link href="/search" className="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                            Search
                        </Link>
                            ...
                            <div className="relative" ref={userMenuRef}>
                                ...
                                {isUserMenuOpen && (
                                    <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-200 dark:border-gray-800 py-2 z-50">
                                        ...
                                        <Link href={user.role === "builder" ? "/dashboard/builder" : "/dashboard"} onClick={() => setIsUserMenuOpen(false)} className="flex items-center gap-3 px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800">
                ...
                <div className="md:hidden absolute top-full w-full bg-white/95 dark:bg-black/95 backdrop-blur-xl border-b border-gray-200 dark:border-gray-800 shadow-xl max-h-[80vh] overflow-y-auto z-40 transition-all origin-top">
                    <div className="px-4 py-6 space-y-6">
                        <div className="space-y-4">
                            ...
                            <Link href="/search" onClick={() => setIsMobileMenuOpen(false)} className="block text-base font-medium text-gray-900 dark:text-gray-100 hover:text-indigo-600 transition-colors">
                                Search Assets
                            </Link>
